      ...
      <ScrollView style={styles.homeScroll} showsVerticalScrollIndicator={false} contentContainerStyle={styles.chatInfoScrollContent}>
        <View style={styles.chatInfoHeroCard}>
          ...
          <View style={styles.chatInfoBadge}>
            <Text style={styles.chatInfoBadgeText}>Versao beta</Text>
          </View>
          <Text style={styles.chatInfoHeroTitle}>Bem-vindo ao Assistente Heal+</Text>
          <Text style={styles.chatInfoHeroText}>
            Uma assistente local para consultar o banco do app com agilidade, sem custo por token e sem depender de servicos externos.
          </Text>
        </View>
        ...
        <View style={styles.chatInfoNotice}>
          ...
          <Text style={styles.chatInfoNoticeText}>
            As respostas sao montadas a partir do banco local e podem conter imprecisoes. Sempre confirme informacoes importantes antes de tomar decisoes clinicas.
          </Text>
        </View>
        ...
        <Text style={styles.chatInfoSupportText}>
          Voce pode voltar ao assistente para fazer uma nova pergunta agora ou abrir a lista de pacientes para conferir os dados manualmente.
        </Text>
